...
class PPO:
    ...
    def update(self, rollouts):
        ...
        # Calculate old action probability and log probability
...
if __name__ == '__main__':
    train('MountainCarContinuous-v0', epochs=50, steps_per_epoch=4000, batch_size=128, lr=0.002, gamma=0.99, clip_ratio=0.2)
